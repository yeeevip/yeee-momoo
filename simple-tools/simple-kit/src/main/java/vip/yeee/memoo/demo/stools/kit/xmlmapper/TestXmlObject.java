package vip.yeee.memoo.demo.stools.kit.xmlmapper;
...
class TestXmlObject {
    @XStreamAlias("class")
    @XStreamAsAttribute
    private String clazz = "vip.yeee.memoo.demo.stools.kit.xmlmapper.A";
    ...
    public static class Subject {
        @XStreamAlias("class")
        @XStreamAsAttribute
        private String clazz = "vip.yeee.memoo.demo.stools.kit.xmlmapper.B";
    ...
    public static class ExtraInfo {
        @XStreamAlias("class")
        @XStreamAsAttribute
        private String clazz = "vip.yeee.memoo.demo.stools.kit.xmlmapper.C";
    ...
    public String toXML() {
        ...
        String temp = "" +
                ...
                "<root defDateFormat=\"yyyy-MM-dd HH:mm:ss\" driver=\"vip.yeee.memoo.demo.stools.kit.xmlmapper.CCCC\" version=\"1.0\">\n" +
                "   {}\n" +
                "</root>";
