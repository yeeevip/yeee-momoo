...
import vip.yeee.memoo.common.doc.kit.TemplatePdfBuilderKit;
import vip.yeee.memoo.common.doc.kit.TemplateWordBuilderKit;
...
//        word2Pdf();
    ...
    private static void buildWord() throws Exception {
        ...
        BufferedInputStream template = FileUtil.getInputStream("C:\\Workspaces\\private\\yeee-memoo\\memoo-parent\\memoo-common\\common-kit\\common-doc-kit\\src\\main\\resources\\template\\example.doc");
    ...
    private static void buildPdf() throws Exception {
        ...
        fillMap.put("PartyA", "甲公司");
        fillMap.put("PartyB", "乙公司");
        BufferedInputStream template = FileUtil.getInputStream("C:\\Workspaces\\private\\yeee-memoo\\memoo-parent\\memoo-common\\common-kit\\common-doc-kit\\src\\main\\resources\\template\\example.pdf");
    ...
    public static void replaceAllFonts() throws Exception {
        ...
        //加载PDF文档
        pdf.loadFromFile("/Users/yeee/Workplaces/private/yeee-memoo/simple-tools/simple-kit/files/1_全文片段对照报告.pdf");
...
//            PdfTrueTypeFont newfont = new PdfTrueTypeFont(new Font("宋体", Font.PLAIN, (int) fontSize), true);
        ...
        //保存文档
        pdf.saveToFile("/Users/yeee/Workplaces/private/yeee-memoo/simple-tools/simple-kit/files/ReplaceAllFonts.pdf");
        pdf.dispose();
    }
