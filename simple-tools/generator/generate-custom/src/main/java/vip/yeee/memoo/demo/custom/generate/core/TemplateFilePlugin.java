...
import vip.yeee.memoo.demo.custom.generate.core.model.TableClass;
import vip.yeee.memoo.demo.custom.generate.core.file.GenerateByListTemplateFile;
import vip.yeee.memoo.demo.custom.generate.core.file.GenerateByTemplateFile;
import vip.yeee.memoo.demo.custom.generate.core.formatter.ListTemplateFormatter;
import vip.yeee.memoo.demo.custom.generate.core.formatter.TemplateFormatter;
import vip.yeee.memoo.demo.custom.generate.core.model.TableColumnBuilder;
...
public class TemplateFilePlugin extends PluginAdapter {
     ...
     * 默认的模板格式化类
     */
    public static final String DEFAULT_TEMPLATEFORMATTER = "vip.yeee.memoo.demo.custom.generate.core.formatter.FreemarkerTemplateFormatter";
    /**
     * 单个文件模式
     */
