...
@Configuration
@MapperScan(basePackages = "vip.yeee.memoo.demo.springboot.domain.mysql.mapper", sqlSessionFactoryRef = "mysqlSqlSessionFactory", sqlSessionTemplateRef = "mysqlSqlSessionTemplate")
