package vip.yeee.memoo.demo.springboot.config;
...
@Configuration
@MapperScan(basePackages = "vip.yeee.memoo.demo.springboot.domain.sqlserver.mapper", sqlSessionFactoryRef = "sqlServerSqlSessionFactory", sqlSessionTemplateRef = "sqlServerSqlSessionTemplate")
